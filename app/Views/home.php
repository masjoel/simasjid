...
<body>
  ...
  <header>
    ...
    <div class="menu">
      <ul>
        <li class="logo"><a href="/home" target="_blank"><img height="44" title="CodeIgniter Logo" alt="Visit CodeIgniter.com official website!" src="<?= base_url() ?>/asset/img/logo.png"></a>
        </li>
        <li class="menu-toggle">
          <button onclick="toggleMenu();">&#9776;</button>
        </li>
        <li class="menu-item hidden"><a href="#">Home</a>
        </li>
    ...
    <div class="heroe">
      ...
      <h1>Sistem Informasi Manajemen Masjid v.1.0</h1>
