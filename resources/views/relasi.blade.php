    ...
    <section class="section">
        <div class="row">
            <div class="col-12 text-center">
                <img src="{{ asset('img/relasi-amin.png') }}" class="img-fluid" style="height: 200px; width:auto"
                    alt="">
                ...
                <form action="{{ route('home') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label>Simpul Relawan (opsional)</label>
                                <input name="simpul" type="text"
                                    class="form-control @error('simpul') is-invalid @enderror" value="{{ old('simpul') }}">
                                @error('simpul')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                <label>Nomor TPS Anda (<a href="https://cekdptonline.kpu.go.id/" target="_blank">Cek
                                        disini)</a></label>
                                <input name="nomor_tps" type="text"
                                    class="form-control @error('nomor_tps') is-invalid @enderror"
                                    value="{{ old('nomor_tps') }}">
                                @error('nomor_tps')
                                    <div class="invalid-feedback">
                                        {{ $message }}
